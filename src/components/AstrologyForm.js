        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-4 flex-1">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1" style={{ color: undefined }}>
                {option.description}
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              >
                <Clock className="w-5 h-5 text-blue-600" style={{ color: undefined }} />
              </div>
              <h3 className="text-xl font-semibold text-gray-800" style={{ color: undefined }}>
                Date & Time
              </h3>
            </div>
            ...
            {/* Date Fields */}
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-gray-600 mb-3 uppercase tracking-wide" style={{ color: undefined }}>
                Date
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2" style={{ color: undefined }}>
                    Year
                  </label>
                  <Input
                    name="year"
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                >
                  <MapPin className="w-5 h-5 text-green-600" style={{ color: undefined }} />
                </div>
                <h3 className="text-xl font-semibold text-gray-800" style={{ color: undefined }}>
                  Location
                </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div className="md:col-span-1">
                <label className="block text-sm font-semibold text-gray-700 mb-2" style={{ color: undefined }}>
                  Latitude
                </label>
                <Input
                  name="latitude"
              ...
              <div className="md:col-span-1">
                ...
                />
                <p className="text-xs text-gray-500 mt-1.5" style={{ color: undefined }}>
                  Offset from UTC
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              >
                <Settings className="w-5 h-5 text-purple-600" style={{ color: undefined }} />
              </div>
              <h3 className="text-xl font-semibold text-gray-800" style={{ color: undefined }}>
                Configuration
              </h3>
