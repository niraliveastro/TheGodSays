      ...
      <div className={styles["auth-landing-container"]}>
        ...
        <div className={styles["auth-landing-grid"]}>
          ...
          >
            ...
            {/* Glow overlay for visual effect */}
            <div className={styles["card-content"]}>
              <div
                className={`${styles["card-icon-wrapper"]} ${styles["user-icon-wrapper"]}`}
              >
              ...
              <div className={styles["card-features"]}>
                <div className={styles["card-feature"]}>
                  <div
                    className={`${styles["feature-dot"]} ${styles["user-dot"]}`}
                  />{" "}
              ...
              <button
                className={`${styles["choice-btn"]} ${styles["user-btn"]}`}
              >
          ...
          >
            <div
              className={`${styles["card-glow"]} ${styles["astrologer-glow"]}`}
            />{" "}
            {/* Glow overlay for visual effect */}
            <div className={styles["card-content"]}>
              <div
                className={`${styles["card-icon-wrapper"]} ${styles["astrologer-icon-wrapper"]}`}
              >
              ...
              <div className={styles["card-features"]}>
                <div className={styles["card-feature"]}>
                  <div
                    className={`${styles["feature-dot"]} ${styles["astrologer-dot"]}`}
                  />{" "}
                  {/* Visual dot indicator */}
              ...
              <button
                className={`${styles["choice-btn"]} ${styles["astrologer-btn"]}`}
              >
