  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        try { 
          if (typeof window !== 'undefined') localStorage.setItem('tgs:role', 'astrologer') 
        } catch (e) {
          ...
          <div className="astrologer-auth-grid">
            ...
            <div className="astrologer-promo-panel">
              ...
              <h2 className="promo-title">
                {isLogin ? 'Welcome Back' : 'Join Our Network'} {/* Dynamic title based on mode */}
              </h2>
            ...
            <div className="astrologer-form-panel">
              ...
              <div className="form-panel-header">
                <h1 className="form-panel-title">
                  {isLogin ? 'Astrologer Sign In' : 'Create Astrologer Profile'} {/* Dynamic title */}
                </h1>
