...
export default function TithiTimingsPage() {
  ...
  const getPakshaBg = (paksha) => {
    return paksha === 'krishna' ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">Current tithi and its completion time</p>
        </div>
        ...
        {isLoading && (
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600">Calculating current tithi timings...</p>
            </CardContent>
          </Card>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
              ...
              <CardContent className="space-y-4">
                ...
                <div className={`p-3 rounded-lg border ${getPakshaBg(tithiData.paksha)}`}>
                  <div className="flex items-center justify-between">
                    <span className="font-medium text-gray-700">Paksha:</span>
                    <span className={`font-semibold capitalize ${getPakshaColor(tithiData.paksha)}`}>
                ...
                <div className="bg-white p-4 rounded-lg border">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-semibold text-gray-800">
                      {tithiData.left_precentage ? `${tithiData.left_precentage.toFixed(1)}% remaining` : 'N/A'}
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div 
                      className="bg-blue-600 h-3 rounded-full transition-all duration-500"
                      style={{ width: `${tithiData.left_precentage ? 100 - tithiData.left_precentage : 0}%` }}
                    ></div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">
                    {tithiData.completes_at ? formatDateTime(tithiData.completes_at) : 'N/A'}
                  </div>
                  <p className="text-sm text-gray-600">
                    {tithiData.completes_at ? 'This tithi will complete at the above time' : 'Completion time not available'}
                  </p>
                </div>
              </CardContent>
            </Card>
