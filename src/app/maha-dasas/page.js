...
export default function MahaDasasPage() {
      ...
      if (response.status === 429) {
        ...
        const mock = {
          ...
          output: JSON.stringify({
            1: {
              Lord: "Sun",
              start_time: "2018-09-11 22:05:25",
              end_time: "2024-09-11 11:00:24",
            },
            2: {
              Lord: "Moon",
              start_time: "2024-09-11 11:00:24",
              end_time: "2034-09-12 00:32:02",
            },
            3: {
              Lord: "Mars",
              start_time: "2034-09-12 00:32:02",
              end_time: "2041-09-11 19:36:11",
            },
            4: {
              Lord: "Rahu",
              start_time: "2041-09-11 19:36:11",
              end_time: "2059-09-12 10:21:09",
            },
            5: {
              Lord: "Jupiter",
              start_time: "2059-09-12 10:21:09",
              end_time: "2075-09-12 12:47:46",
            },
            6: {
              Lord: "Saturn",
              start_time: "2075-09-12 12:47:46",
              end_time: "2094-09-12 09:41:53",
            },
            7: {
              Lord: "Mercury",
              start_time: "2094-09-12 09:41:53",
              end_time: "2111-09-13 18:17:41",
            },
            8: {
              Lord: "Ketu",
              start_time: "2111-09-13 18:17:41",
              end_time: "2118-09-13 13:21:50",
            },
            9: {
              Lord: "Venus",
              start_time: "2118-09-13 13:21:50",
              end_time: "2138-09-13 16:25:07",
            },
          }),
        };
  ...
  const planetIcon = (lord) => {
    ...
    return (
      map[lord.toLowerCase()] || <Star style={{ width: 28, height: 28 }} />
    );
  };
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      ...
      text: `Check out my current planetary periods! Currently in ${
        Object.values(parsed).find(isCurrent)?.Lord || "Unknown"
      } Dasa.`,
                      ...
                      <div className="titleGroup">
                        ...
                        <p className="desc">
                          {(() => {
                            ...
                            return (
                              desc[d.Lord.toLowerCase()] || "Planetary period"
                            );
                          })()}
                        </p>
                      </div>
